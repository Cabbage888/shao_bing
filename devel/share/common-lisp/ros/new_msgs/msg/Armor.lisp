...
(cl:defmethod cl:initialize-instance :after ((m <Armor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Armor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name new_msgs-msg:<Armor> is deprecated: use new_msgs-msg:Armor instead.")))

(cl:ensure-generic-function 'grade-val :lambda-list '(m))
(cl:defmethod grade-val ((m <Armor>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Armor>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'grade)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 18446744073709551616) signed)))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Armor>) istream)
  "Deserializes a message object of type '<Armor>"
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:slot-value msg 'grade) (cl:if (cl:< unsigned 9223372036854775808) unsigned (cl:- unsigned 18446744073709551616))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Armor>)))
  ...
  "f01bc42540f7302c184397f596483711")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Armor)))
  "Returns md5sum for a message object of type 'Armor"
  "f01bc42540f7302c184397f596483711")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Armor>)))
  ...
  (cl:format cl:nil "int64 grade~%int64 id~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Armor)))
  "Returns full string definition for message of type 'Armor"
  (cl:format cl:nil "int64 grade~%int64 id~%float64 x~%float64 y~%float64 z~%~%"))
