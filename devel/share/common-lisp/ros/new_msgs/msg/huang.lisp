...
(cl:defclass <huang> (roslisp-msg-protocol:ros-message)
  ((num
    :reader num
    :initarg :num
    :type cl:fixnum
...
(cl:defclass huang (<huang>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <huang>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'huang)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name new_msgs-msg:<huang> is deprecated: use new_msgs-msg:huang instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <huang>))
...
(cl:defmethod grade-val ((m <huang>))
...
(cl:defmethod z-val ((m <huang>))
  ...
  (z m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <huang>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <huang>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<huang>)))
  "Returns string type for a message object of type '<huang>"
  "new_msgs/huang")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'huang)))
  "Returns string type for a message object of type 'huang"
  "new_msgs/huang")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<huang>)))
  "Returns md5sum for a message object of type '<huang>"
  "46fb889fe7931e25e4f6c75cb36330e9")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'huang)))
  "Returns md5sum for a message object of type 'huang"
  "46fb889fe7931e25e4f6c75cb36330e9")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<huang>)))
  "Returns full string definition for message of type '<huang>"
  (cl:format cl:nil "int8 num~%int8[] id~%int32[] grade~%float32[] yaw~%float32[] x~%float32[] y~%float32[] z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'huang)))
  "Returns full string definition for message of type 'huang"
  (cl:format cl:nil "int8 num~%int8[] id~%int32[] grade~%float32[] yaw~%float32[] x~%float32[] y~%float32[] z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <huang>))
  (cl:+ 0
     1
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <huang>))
