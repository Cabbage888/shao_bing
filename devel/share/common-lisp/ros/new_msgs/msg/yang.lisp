...
;//! \htmlinclude yang.msg.html

(cl:defclass <yang> (roslisp-msg-protocol:ros-message)
  ((num
    :reader num
    :initarg :num
    :type cl:fixnum
...
(cl:defclass yang (<yang>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <yang>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'yang)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name new_msgs-msg:<yang> is deprecated: use new_msgs-msg:yang instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <yang>))
...
(cl:defmethod z-val ((m <yang>))
  ...
  (z m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <yang>) ostream)
  "Serializes a message object of type '<yang>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <yang>) istream)
  "Deserializes a message object of type '<yang>"
    (cl:let ((unsigned 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<yang>)))
  "Returns string type for a message object of type '<yang>"
  "new_msgs/yang")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'yang)))
  "Returns string type for a message object of type 'yang"
  "new_msgs/yang")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<yang>)))
  "Returns md5sum for a message object of type '<yang>"
  "c8ce65f94947c6f6defe83fa1b7d18f5")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'yang)))
  "Returns md5sum for a message object of type 'yang"
  "c8ce65f94947c6f6defe83fa1b7d18f5")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<yang>)))
  "Returns full string definition for message of type '<yang>"
  (cl:format cl:nil "int8 num~%int8 id~%int32 grade~%float32 yaw~%float32 x~%float32 y~%float32 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'yang)))
  "Returns full string definition for message of type 'yang"
  (cl:format cl:nil "int8 num~%int8 id~%int32 grade~%float32 yaw~%float32 x~%float32 y~%float32 z~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <yang>))
  (cl:+ 0
     1
     1
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <yang>))
