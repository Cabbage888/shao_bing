...
class huang {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type huang
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type huang
    let len;
    let data = new huang(null);
