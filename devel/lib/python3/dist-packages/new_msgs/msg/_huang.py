...
"""autogenerated by genpy from new_msgs/huang.msg. Do not edit."""
import codecs
import sys
...
class huang(genpy.Message):
  _md5sum = "46fb889fe7931e25e4f6c75cb36330e9"
  _type = "new_msgs/huang"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(huang, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.grade)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.grade))
      length = len(self.yaw)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.grade = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(self.grade.tostring())
      length = len(self.yaw)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.grade = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
