...
"""autogenerated by genpy from new_msgs/vector_Armor.msg. Do not edit."""
import codecs
import sys
...
class vector_Armor(genpy.Message):
  _md5sum = "cf7c5ccb1a8c18d9d98118393187f319"
  _type = "new_msgs/vector_Armor"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """int64[] grade
int64[] id
float64[] x
float64[] y
float64[] z"""
  __slots__ = ['grade','id','x','y','z']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(vector_Armor, self).__init__(*args, **kwds)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.grade = numpy.frombuffer(str[start:end], dtype=numpy.int64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sq'%length
