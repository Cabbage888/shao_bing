...
public:
    ...
    Eigen::Vector3d pixel2ros_imu(Armor &armor, double yaw);               // 像素坐标转换为电控云台坐标系
    /** 四元数旋转矩阵 */
...
private:
    ...
    /** 视觉云台坐标系转换为电控云台坐标系(调用接口) */
    Eigen::Vector3d imu2ros_imu(Eigen::Vector3d imu_pos, double yaw);       // 视觉云台坐标系转换为电控云台坐标系
